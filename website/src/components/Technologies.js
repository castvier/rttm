        ...
        <div className="row">
          ...
          <div className="col-md-6 technology-section">
            ...
            <ul className="tech-list">
              ...
              <li>
                ...
                <img src={process.env.PUBLIC_URL + "/images/img-technologies/ReactJS-Framework-Benefits.png"} alt="React" className="tech-image" />
              </li>
              <li>
                ...
                <img src={process.env.PUBLIC_URL + "/images/img-technologies/Bootstrap+React.png"} alt="Bootstrap" className="tech-image" />
              </li>
            </ul>
          </div>
          ...
          <div className="col-md-6">
            ...
            <ul className="tech-skills-list">
              <li>
                <img src={process.env.PUBLIC_URL + "/images/img-technologies/DataAcquisitionImg.png"} alt="Data Processing" className="tech-image" />
                Data Processing: Utilizing MATLAB for data analysis, preprocessing, and visualization to gain insights from the collected traffic data.
              </li>
              <li>
                <img src={process.env.PUBLIC_URL + "/images/img-technologies/TechnologyLidarPicture.png"} alt="3D Environmental Scanning" className="tech-image" />
                3D Environmental Scanning: Employing LiDAR technology, specifically Velodyne LiDAR, for high-resolution 3D scanning of traffic environments.
              </li>
              <li>
                Cloud Computing: Leveraging AWS services for scalable and efficient data storage, processing, and deployment.
              </li>
              <li>
                <img src={process.env.PUBLIC_URL + "/images/img-technologies/TechnologyTrafficPicture.png"} alt="Traffic Analysis" className="tech-image" />
                Traffic Analysis: Applying data analytics techniques to derive meaningful insights from traffic patterns, congestion levels, and vehicle behavior.
              </li>
              <li>
                <img src={process.env.PUBLIC_URL + "/images/img-technologies/techused.jpg"} alt="Web Development" className="tech-image" />
                Web Development: Creating interactive and user-friendly web interfaces using modern web development technologies to present traffic data effectively.
              </li>
            </ul>
          </div>
        </div>
